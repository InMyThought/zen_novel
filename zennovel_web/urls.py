...
# Import views biasa (HTML) dan api views (JSON)
...
urlpatterns = [
    ...
    # --- WEBSITE HTML (Tradisional) ---
    path('', html_views.home, name='home'),
    path('search/', html_views.search, name='search'), # <--- Error hilang disini
